        ...
        "derived_stats": [
            {
                ...
                "mechanic": "This is your health pool before any gear bonuses. Verified from the game binary: MaxHealthBase = base * (1 + modifier), where the base comes from the Vigor curve and the modifier comes from gear/buffs. The curve has diminishing returns — early points of Vigor give more HP than later ones.",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Your total Move Speed = Base (300) + this bonus, hard capped at 330. Verified from the binary: the MoveSpeed calculation reads directly from the AbilitySystemComponent, combining multiple sources in a complex formula. A Rogue with 25 AGI gets +5 bonus = 305 move speed. Below 15 AGI you get a penalty.",
    ...
    },
    {
        ...
        "derived_stats": [
            ...
            },
            {
                ...
                "mechanic": "Each spell has a memory cost. Your Memory Capacity limits which spells you can equip. Verified from the game binary: the result is rounded to a whole number using the formula round(base * (1 + modifier) + flat_bonus). Below 7 Knowledge you get zero capacity. A Wizard with 25 KNO gets 19 capacity, enough for several spells.",
                "curve_table": "CT_Knowledge",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Controls how fast you open chests, unlock doors, disarm traps, and revive teammates. Verified from the binary: the RegularInteractionSpeedBase formula uses 1 - clamp(A/B, 0, 1), an inverse ratio. A Rogue with 25 RES gets +52% — they open chests roughly 1.5x faster than a Fighter.",
