        ...
        "derived_stats": [
            {
                ...
                "mechanic": "This is your health pool before any gear bonuses. Your base HP from the Vigor curve gets multiplied by any % HP modifiers from gear — so a +10% Max Health ring applies on top of this value. The curve has diminishing returns: early Vigor points give more HP than later ones. A Fighter (15 VIG) gets 115 HP, a Barbarian (25 VIG) gets 131.5 HP.",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Your total Move Speed = Base (300) + this bonus, hard capped at 330. The game combines your Agility curve bonus with gear and buff bonuses to get the final speed. A Rogue with 25 AGI gets +5 bonus = 305 move speed. A Ranger with 20 AGI gets +2.5 = 302.5. Below 15 AGI you get a penalty — at 0 AGI you'd lose 10 move speed.",
            ...
            },
            {
                ...
                "mechanic": "Action Speed controls how fast you swing weapons, draw bows, and block. Both Agility and Dexterity contribute, but Dexterity matters 3x more. The game combines them as: (0.25 x Agility) + (0.75 x Dexterity), then looks up the result on the curve below. Example: a Rogue (25 AGI, 20 DEX) gets input = 0.25x25 + 0.75x20 = 21.25, which gives about +7.8% faster attacks.",
                "curve_table": "CT_Agility",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Dexterity is the main Action Speed stat — each point of DEX gives 3x more Action Speed than a point of AGI. The game uses the same curve for both, but weights them differently: (0.25 x Agility) + (0.75 x Dexterity). If you want faster attacks, DEX is what you stack.",
    ...
    },
    {
        ...
        "derived_stats": [
            ...
            },
            {
                ...
                "mechanic": "Each spell has a memory cost. Your Memory Capacity limits which spells you can equip. The game rounds the final result to a whole number — so gear with +Memory Capacity adds flat slots on top of your Knowledge-based capacity. Below 7 Knowledge you get zero capacity and can't equip any spells. A Wizard with 25 KNO gets 19 capacity.",
                "curve_table": "CT_Knowledge",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Controls how fast you open chests, unlock doors, disarm traps, and revive teammates. The bonus scales as an inverse ratio with diminishing returns at very high values. A Rogue with 25 RES gets +52% — they open chests roughly 1.5x faster than a Fighter at baseline.",
