...
const COMMUNITY_LINKS = [
  { href: "https://discord.gg/2k8JXHvhzE", label: "Discord", external: true },
      ...
      <div className="container">
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            <a href="https://discord.gg/2k8JXHvhzE" className="navbar-icon-btn" aria-label="Discord" target="_blank" rel="noopener noreferrer">
