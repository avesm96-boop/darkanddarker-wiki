    ...
    },
    {
        ...
        "derived_stats": [
            ...
            },
            {
                ...
                "mechanic": "Action Speed controls how fast you swing weapons, draw bows, and block. Both Agility and Dexterity contribute, but the game describes Agility's contribution as 'slight' while Dexterity is the primary driver. The formula is 0.25 × Agility + 0.75 × Dexterity, meaning Dexterity has 3× more influence per point. Both stats use the same curve (shown below).",
                "curve_table": "CT_Agility",
        ...
        "derived_stats": [
            {
                ...
                "mechanic": "Dexterity is the primary Action Speed stat — the game itself says it directly 'increases your action speed' while Agility only 'slightly' increases it. The formula is 0.25 × Agility + 0.75 × Dexterity, both fed into this curve. Prioritize Dexterity when optimizing attack speed.",
